...
public class GeneratorXmlSql {
    ...
    @Test
    public void client()  {
//        String fileDir = "/Users/pipi/business/citydo/project/credit/credit-service/credit-part/src/main/resources/mapper/part/DataUseOrganizationMapper.xml";
...
//
//        Set<String> voPropertySet = getVoFieldSet(DataUseOrganizationPageVo.class);
//        String  dtoStr = getDTOFieldStr(DataUseOrganizationPageDTO.class);
//
//
